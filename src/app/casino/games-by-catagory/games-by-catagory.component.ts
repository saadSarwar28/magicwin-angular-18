...
@Component({
  selector: 'app-games-by-catagory',
  templateUrl: './games-by-catagory.component.html',
  styleUrls: [
    './games-by-catagory.component.scss',
    '../casino-footer.component.scss',
  ],
})
export class GamesByCatagoryComponent implements OnInit, AfterViewInit {
  showVS: any = false;
  ...
  defaultImage: string = 'https://iriscdn.b-cdn.net/CasinoImages/preloader.svg';
